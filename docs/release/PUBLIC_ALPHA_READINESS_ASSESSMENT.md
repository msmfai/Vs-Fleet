...
- Release gates cover license metadata, DCO/contribution posture, local data,
  ...
  exposure, secrets, dependency review, CI, and GitHub publication readiness.
...
- Current private branch history contains local paths and generated/eval
  ...
  that exposure.
- Public CI, GitHub publication settings, public-branch verification, and
  dependency review still need matching owner decisions and final public-ref
  checks.
...
3. `./scripts/release-check.sh` passes on the exact source tree to publish.
